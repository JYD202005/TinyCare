...
const PRODUCTS: Product[] = [
  {
    ...
    features: [
      "Monitoreo continuo de oxígeno en sangre",
      "Registro de frecuencia cardíaca",
      "Tejido hipoalergénico transpirable",
    ...
    userReviews: [
      {
        ...
        rating: 5,
        comment:
          "Excelente precisión en lecturas de SpO2. Muy confiable para monitoreo en casa.",
        date: "12 May 2026",
      },
      {
        user: "Carlos R.",
        rating: 5,
        comment:
          "La tranquilidad que da este nivel de monitoreo médico es invaluable.",
        date: "05 May 2026",
      },
    ],
  },
  {
    ...
    features: [
      "Sensor infrarrojo sin contacto directo",
      "Alertas de temperatura predictivas",
      "Material lavable a máquina",
    ...
    userReviews: [
      {
        ...
        rating: 5,
        comment:
          "Me avisó de un pico de fiebre horas antes de que se notara. Material de primera.",
        date: "27 Abr 2026",
      },
    ],
  },
  {
    ...
    features: [
      "Detección de posición prona peligrosa",
      "Análisis de calidad de sueño por movimiento",
      "Giroscopio de alta precisión",
      "Costuras invisibles anti-roce",
    ],
    userReviews: [
      {
        user: "Sofía V.",
        rating: 5,
        comment:
          "Nos da mucha paz saber en qué posición duerme sin tener que entrar a su cuarto.",
        date: "26 Abr 2026",
      },
    ],
  },
  {
    ...
    features: [
      ...
      "Alertas de apnea infantil",
      "Calibración automática",
      "Módulo removible para lavado intenso",
    ],
    userReviews: [
      {
        user: "Dr. Álvarez (Pediatra)",
        rating: 5,
        comment:
          "Lecturas comparables con equipos de clínica. Excelente desarrollo.",
        date: "02 May 2026",
      },
    ],
  },
  {
    ...
    features: [
      "Telemetría completa de grado médico",
      "Estación base de carga",
      "Suscripción premium a reportes pediátricos",
    ...
    userReviews: [
      {
        ...
        rating: 5,
        comment:
          "La inversión vale cada peso. Es tener terapia intermedia en casa.",
        date: "24 Abr 2026",
      },
    ],
  },
...
const ProductImage: React.FC<{
  ...
  style?: any;
  color?: string;
}> = ({ productId, style, color = TC.textMuted }) => {
  ...
  return (
    ...
    >
      <Ionicons
        ...
        size={style?.width ? style.width * 0.4 : 24}
        color={color}
        style={{ opacity: 0.6 }}
      />
    </View>
          ...
          >
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  ...
                  <Text style={modal.ratingText}>
                    {product.rating} ({product.reviews} verificadas)
                  </Text>
                </View>
              </View>
            ...
            <View style={modal.tagsRow}>
              {product.tags.map((t) => (
                <View
                  key={t}
                  style={[modal.tag, { borderColor: product.colors[0] }]}
                >
                  <Text style={[modal.tagText, { color: product.colors[0] }]}>
                    {t}
                  </Text>
                </View>
              ))}
            ...
            <View style={modal.tabRow}>
              {(["specs", "reviews"] as const).map((t) => (
                ...
                >
                  <Text
                    style={[modal.tabText, tab === t && modal.tabTextActive]}
                  >
                    {t === "specs"
                      ? "Especificaciones"
                      : `Reseñas (${product.userReviews.length})`}
                  </Text>
                </TouchableOpacity>
              ))}
            </View>
            ...
            {tab === "specs" ? (
              <View style={modal.featureList}>
                ...
                <Text style={[modal.sectionSubtitle, { marginTop: 16 }]}>
                  CARACTERÍSTICAS
                </Text>
              ...
              <View style={modal.reviewsList}>
                {product.userReviews.map((r, i) => (
                  <View
                    ...
                    style={[
                      modal.reviewCard,
                      i < product.userReviews.length - 1 && modal.reviewBorder,
                    ]}
                  >
        ...
        <View style={[modal.sheet, { height: "80%" }]}>
          ...
          {cart.length === 0 ? (
            ...
            >
              ...
              />
              <Text
                style={{ fontSize: 16, color: TC.textMuted, fontWeight: "500" }}
              >
                El carrito está vacío
              </Text>
              <TouchableOpacity
                style={[modal.cta, { width: "80%", marginTop: 24 }]}
                onPress={onClose}
              >
    ...
    <View style={SharedStyles.screenRoot}>
      ...
      <Animated.ScrollView
        contentContainerStyle={[
          ...
          { paddingTop: getScreenTopPadding(insets.top), gap: 20 },
        ]}
        showsVerticalScrollIndicator={false}
      ...
      >
        {/* Header */}
        <Animated.View
          style={[SharedStyles.screenHeader, { opacity: headerOpacity }]}
        >
          <View>
            <Text style={Typography.eyebrow}>EQUIPO MÉDICO CERTIFICADO</Text>
            <Text style={Typography.screenTitle}>TinyCare Store</Text>
          </View>
          <TouchableOpacity
            style={s.cartBtn}
            activeOpacity={0.7}
        ...
        <View style={s.banner}>
          <View style={s.bannerContent}>
            ...
            <Text style={s.bannerDesc}>
              Sensores encapsulados en silicona médica biocompatible. Telemetría
              vía BLE con protección IP67/IP68. Lavables y seguros.
            </Text>
          </View>
        </View>
        ...
        >
          {CATEGORIES.map((c) => (
            ...
            >
              <Text
                style={[s.catText, activeCategory === c && s.catTextActive]}
              >
                {c}
              </Text>
            </TouchableOpacity>
                ...
                <View style={s.cardFooter}>
                  ...
                  <View style={s.cardTags}>
                    {p.tags.slice(0, 1).map((t) => (
                      <Text key={t} style={s.miniTagText}>
                        {t}
                      </Text>
                    ))}
                  </View>
        ...
        <View style={s.footer}>
          ...
          <Text style={s.footerText}>
            Todos los componentes biométricos cumplen con la normativa NOM-151 y
            certificación CE. Encapsulado IP67/IP68 resistente a fluidos
            corporales y lavados intensivos. © 2026 TinyCare — InnovaTecNM.
          </Text>
        </View>
      </Animated.ScrollView>
